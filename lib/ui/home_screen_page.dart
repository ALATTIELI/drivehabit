        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.location_on, color: Color(0xFF44a7f4), size: 24),
                  SizedBox(width: 8),
                  Expanded(
                    child: Text(
                      'Latitude: ${_currentPosition != null ? _currentPosition!.latitude.toStringAsFixed(5) : 'Loading...'}',
                      style: TextStyle(
                          fontSize: 24,
                          fontWeight: FontWeight.bold,
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Longitude: ${_currentPosition != null ? _currentPosition!.longitude.toStringAsFixed(5) : 'Loading...'}',
                      style: TextStyle(
                          fontSize: 24,
                          fontWeight: FontWeight.bold,
                          color: Color(0xFF44a7f4)),
              ...
              Row(
                children: [
                  Icon(Icons.speed, color: Color(0xFF44a7f4), size: 24),
                  SizedBox(width: 8),
                  Expanded(
                    child: Text(
                      'Speed: ${_currentPosition != null ? (_currentPosition!.speed * 3.6).toStringAsFixed(2) : 'Loading...'} km/h',
                      style: TextStyle(
                          fontSize: 24,
                          fontWeight: FontWeight.bold,
                          color: Color(0xFF44a7f4)),
                ...
                Row(
                  children: [
                    Icon(Icons.error_outline,
                        color: Color(0xFF44a7f4), size: 24),
                    SizedBox(width: 8),
                    Expanded(
                      child: Text(
              ...
              Row(
                children: [
                  Icon(Icons.error_outline, color: Color(0xFF44a7f4), size: 24),
                  SizedBox(width: 8),
                  Expanded(
                    child: Text(
                      'Mistakes: $_mistakes',
